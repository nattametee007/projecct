...
<body>
    ...
    <div class="container" id="product-grid">
        ...
        ?>
                <div class="row">
                    <div class="col-sm-2" id="category-list">
                        <ul class="nav nav-pills flex-column">
                            <li class="nav-item">
                                <a class="nav-link active" href="#">
                                    <?php echo $product_array[$key]["category"];
                                     $list = $product_array[$key]["category"];?>
                                    </a>
                            </li>
                        </ul>
                    </div>
            ...
            ?>
            <div class="col-sm-10" id="category-list">
                <?php
               
                $product_array = $db_handle->runQuery("SELECT * FROM inventory WHERE category='$list' ");
                if (!empty($product_array)) {
                    foreach ($product_array as $key => $value) {
                ?>
                        <div class="product-item container">
                            ...
                            <div class="product-tile-footer row">
                                <div class="product-title col-sm-4 p-3 bg-dark text-white">
                                    <?php echo $product_array[$key]["product_name"]; ?></div>
                                <div class="product-price  col-sm-4 p-3 bg-dark text-white">
                                    <?php echo "$" . $product_array[$key]["cost"]; ?></div>
                            </div>
