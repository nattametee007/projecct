<?php 
    ...
    if (!isset($_SESSION['inventory_login'])) {
...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="inventory.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
        ...
        <span class="navbar-toggler-icon"></span>
            ...
            <div style='margin-right:60%;'>
                <a href='inventory.php'><button type="button" class="btn btn-secondary btn-lg">คำสั่งซื้อ</button></a>
                <a href='#'><button type="button" class="btn btn-secondary btn-lg">จัดการคลังสินค้า</button></a>
            </div>
