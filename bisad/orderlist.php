        ...
        <div class="container row">
            <div class="container col-2  ">
                ...
                <ul class="nav nav-pills" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="pill" href="#allorderid">
                    ...
                    foreach ($all as $value) { ?>
                            ...
                            <a class="nav-link" data-bs-toggle="pill" href="#orderid<?php echo $value; ?>">
                                <?php echo $value; ?>
                            </a>
...
foreach ($all as $value3) { ?>
        ...
        <div class="product-image col-sm-12 card">
