                    ...
                    <form method="POST">
                        <div class="container" style="text-align: left;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" class="form-check-input" id="check1" name="option1"
                                    value="something" checked>
                                <label class="form-check-label"
                                    for="check1"><?php echo $product_array[$key]["size"]; ?></label>
                                <input type="checkbox" class="form-check-input" disabled>
                        ...
                        <div class="container row">
                            ...
                            <div class="container col">
                                <a class="container btn btn-outline-info"
                                    href="payment.php?product='<?php echo $product_array[$key]["product_id"]; ?>'&user='<?php echo $user; ?>'">
                                    สั่งซื้อสินค้า
                                </a>

                            </div>
                            <div class="container col">
                                <input type="submit" value="เพิ่มลงตะกร้า" class="container btn btn-outline-info"
                                    name="btn">
