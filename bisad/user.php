            ...
            <div class="container row">
                <div class="container col-2  ">
                    ...
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" style='background-color: #D99B84; color: #000000; padding-left:29px; padding-right:29px;' data-bs-toggle="pill" href="#hommy">
                                <h6>หมวดหมู่</h6>
                            </a>
                            <br>
                        </li>
                        ...
                        <li class="nav-item">
                            ...
                            foreach ($all as $value) { ?>
                                ...
                                <a class="nav-link" style='background-color: #D99B84; color: #000000;' data-bs-toggle="pill" href="#<?php echo $value; ?>">
                                    <?php echo $value; ?>
                                </a>
                                <br>
