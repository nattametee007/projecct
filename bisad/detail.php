...
<body>
    <nav class="navbar navbar-expand-sm bg-dark navbar-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="category.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
    ...
    <div class="container row" id="product-grid">
		...
		<div class="product-item container">
            ...
            <div class="product-title "><?php echo $product_array[$key]["colour"]; ?></div>           
